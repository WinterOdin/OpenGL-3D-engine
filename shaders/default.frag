...
float getSoftShadowX4() {
    ...
    shadow += lookup(-1.5 * swidth + offset.x, -0.9 * swidth - offset.y);
    shadow += lookup( 0.9 * swidth + offset.x, 1.5 * swidth - offset.y);
    shadow += lookup( 0.9 * swidth + offset.x, -0.9 * swidth - offset.y);
    return shadow / 4.0;
}
